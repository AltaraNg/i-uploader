...
export async function POST(request) {
   try {
      ...
      var sql = `UPDATE customers SET add_street = '${add_street}', add_addinfo_description = '${add_addinfo_description}', add_houseno = '', add_nbstop = '', city = '', state = '', area_address = '' WHERE id = ${id}`;
